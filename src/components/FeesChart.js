...
export default function FeesChart(props) {
  ...
  const csvFields = [
    ...
    {key: 'mint', name: 'Mint RLP'},
    {key: 'burn', name: 'Burn RLP'},
      ...
      >
        <ResponsiveContainer width="100%" height={chartHeight}>
          <ComposedChart data={formattedData} syncId="syncA">
            ...
            <Bar unit={viewSettings.itemsUnit} isAnimationActive={false} type="monotone" dataKey="mint" stackId="a" name="Mint RLP" fill={COLORS[1]} />
            <Bar unit={viewSettings.itemsUnit} isAnimationActive={false} type="monotone" dataKey="burn" stackId="a" name="Burn RLP" fill={COLORS[2]} />
        ...
        <div className="chart-description">
          Collected fees. USD value is calculated with token price at the moment of swap, trade, minting or redeeming RLP
        </div>
      </ChartWrapper>
  )
}